        ...
        <v-dialog 
            ...
            <div class="formArea">
                ...
                <div class="line clearfix">
                    <label for="groupId" class="pull-left"><sup>* </sup>组ID：</label>
                    <input 
                        class="inputCom readonly"
                        :style="{'width':'320px'}" 
                        readonly="readonly"
                        v-model="formValue.groupId.value">
                </div>

                <div class="line clearfix">
                    <label for="groupName" class="pull-left"><sup>* </sup>组名称：</label>
                    <input
                        class="inputCom"
                        :style="{'width':'320px'}"
                        placeholder="请输入平台名称"
                        v-model="formValue.groupName.value"
    ...
    export default {
        ...
        data(){
            return {
                ...
                isShowWarnTip:false,
                formValue:{
                    groupId:{value:"",label:"组ID"},
                    groupName:{value:"",label:"组名称"},
        ...
        computed:{
            submitValue(){
                return  {
                    groupId:this.formValue.groupId.value,
                    groupName:this.formValue.groupName.value,
