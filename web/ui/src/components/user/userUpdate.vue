        ...
        <v-dialog 
            ...
            <div class="formArea">
                ...
                <div class="line clearfix">
                    <label for="userId" class="pull-left"><sup>* </sup>用户ID：</label>
                    <input 
                        class="inputCom readonly"
                        :style="{'width':'320px'}" 
                        readonly="readonly"
                        v-model="formValue.userId.value">
                </div>
...
<script>
    export default {
        ...
        computed:{
            submitValue(){
                return  {
                    userId:this.formValue.userId.value,
        ...
        methods:{
            ...
            checkUserName(e){
                ...
                if(!this.defaultData["userName"] || (this.submitValue["userName"]==this.defaultData["userName"])) {
                  this.isShowUserNameCheck = false
                  return
                }
