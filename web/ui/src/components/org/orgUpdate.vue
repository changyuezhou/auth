        ...
        <v-dialog 
            ...
            <div class="formArea">
                ...
                <div class="line clearfix">
                    <label for="organizationId" class="pull-left"><sup>* </sup>组织ID：</label>
                    <input 
                        class="inputCom readonly"
                        :style="{'width':'320px'}" 
                        readonly="readonly"
                        v-model="formValue.organizationId.value">
                </div>
                ...
                <div class="line clearfix">
                    <label for="organizationFId" class="pull-left"><sup>* </sup>父组织ID：</label>
                    <input 
                        class="inputCom readonly"
                        :style="{'width':'320px'}" 
                        readonly="readonly"
                        v-model="formValue.organizationFId.value">
                </div>
                <div class="line clearfix">
                    <label for="platformId" class="pull-left"><sup>* </sup>平台ID：</label>
                    <input 
                        class="inputCom readonly"
                        :style="{'width':'320px'}" 
                        readonly="readonly"
                        v-model="formValue.platformId.value">
                </div>                                
    ...
    export default {
        ...
        data(){
            return {
                ...
                isShowWarnTip:false,
                formValue:{
                    organizationId:{value:"",label:"组织ID"},
                    organizationName:{value:"",label:"组织名称"},
                    organizationFId:{value:"",label:"父组织ID"},
                    platformId:{value:"",label:"平台ID"},
        ...
        computed:{
            submitValue(){
                return  {
                    organizationId:this.formValue.organizationId.value,
